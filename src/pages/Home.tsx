  ...
  const competitiveAdvantages = [
    {
      ...
      detail:
        "While others rush, we ensure every item meets our quality standards",
      color: "blue",
      badge: "Quality First",
    },
    {
  ...
  const stats = [
    {
      ...
      sublabel: "vs 85% industry avg",
    },
    {
      number: "45min",
      label: "Reliable Delivery",
      sublabel: "Consistent timing",
    },
    {
      number: "50K+",
      label: "Happy Customers",
      sublabel: "4.9★ average rating",
    },
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center">
            ...
            <p className="text-xl md:text-2xl mb-8 max-w-4xl mx-auto leading-relaxed">
              While others rush and compromise quality, we deliver{" "}
              <strong>fresh, hand-picked groceries</strong> in a reliable 45
              minutes with <strong>zero hidden fees</strong>
            </p>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-5xl mx-auto">
              {stats.map((stat, index) => (
                <div
                  key={index}
                  className="text-center bg-white bg-opacity-10 backdrop-blur-sm rounded-2xl p-4"
                >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <div className="inline-flex items-center bg-red-100 text-red-800 rounded-full px-4 py-2 mb-4">
              ...
              <span className="text-sm font-medium">
                The Problem with 10-Minute Delivery
              </span>
            </div>
            ...
            <p className="text-xl text-gray-600 max-w-4xl mx-auto">
              10-minute delivery sounds great, but at what cost? Here's why
              ThikGro's approach delivers better value
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {competitiveAdvantages.map((advantage, index) => (
              <div
                key={index}
                className="group text-center p-8 rounded-2xl bg-gray-50 hover:bg-white hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border-2 border-transparent hover:border-green-200"
              >
                <div className="relative">
                  <div
                    className={`flex justify-center mb-6 p-4 rounded-full bg-${advantage.color}-100 w-20 h-20 mx-auto group-hover:scale-110 transition-transform duration-300`}
                  >
                    {advantage.icon}
                  </div>
                  <div
                    className={`absolute -top-2 -right-2 bg-${advantage.color}-500 text-white text-xs px-2 py-1 rounded-full font-bold`}
                  >
                    {advantage.badge}
                  </div>
                </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Every aspect of our service is designed for quality, reliability,
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {features.map((feature, index) => (
              <div
                key={index}
                className="group text-center p-8 rounded-2xl bg-white hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2"
              >
                <div
                  className={`flex justify-center mb-6 p-4 rounded-full bg-${feature.color}-100 w-20 h-20 mx-auto group-hover:scale-110 transition-transform duration-300`}
                >
                  {feature.icon}
                </div>
                <h3 className="text-xl font-bold text-gray-900 mb-3">
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Every item is carefully selected by our personal shoppers for
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600">
              Real feedback from customers who switched from 10-minute delivery
              services
            </p>
          </div>
            ...
            {[
              {
                ...
                review:
                  "I was tired of receiving bruised fruits and wrong items. ThikGro's quality is worth the extra 35 minutes. My groceries actually last longer now!",
                rating: 5,
                avatar: "👩‍💼",
              ...
              },
              {
                ...
                review:
                  "Other services rush and make mistakes. ThikGro's personal shoppers understand quality ingredients. No more surprise charges either!",
                rating: 5,
                avatar: "👨‍🍳",
              ...
              },
              {
                ...
                role: "Busy Parent",
                review:
                  'Reliable 45-minute delivery beats unpredictable "10-minute" service that often takes an hour. Plus, no hidden fees during peak times!',
                rating: 5,
                avatar: "👩‍👧‍👦",
              ...
              <div
                key={index}
                className="bg-white p-8 rounded-2xl hover:shadow-lg transition-all duration-300 transform hover:-translate-y-1 border-l-4 border-green-500"
              >
